...
/***/ (function(module, exports, __webpack_require__) {
	...
	var View = function () {
	    ...
	    View.prototype.setBound = function setBound() {
			var posH = $(".floating-layer").height();
	        ...
	        dom.setBound(this.container, { top: top, right: right, bottom: bottom, left: left, width: width, height: 'auto' });
	        dom.css(this.container, { marginLeft: - marginLeft + 'px', marginTop: - marginTop + 'px'});
