        ...
        <!-- header -->
			...
			<div class="content">
				...
				<div class="paging_box">
                    ...
                    <div class="btn_box">
                        <button type="button" class="btn btn_default" onClick="javascript:switchContent('/admin/alert/popp_write');">글쓰기</button>
                    </div>
				</div>
				<!-- // 페이징 + 버튼 -->
		...
		function fnSelectListCall() {
			...
			var pushEndDt =nvl($("#pushEndDt").val(),'');
			  ...
			  lvParams = {
					      ...
					      , "taskSe": taskSe
					      , "title" : title
					      , "pushBeginDt" : pushBeginDt.replace(/-/gi,"")
					      , "pushEndDt" : pushEndDt.replace(/-/gi,"")
					     };
